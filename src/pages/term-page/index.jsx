...
const TermPage = () => {
    ...
    return (
        <div className="term-container">
            ...
            <div className="term-footer">Thank you for choosing AuctionKoi.com. Your privacy is important to us, and we are committed to providing a secure and positive experience.</div>
        </div>
    );
};
