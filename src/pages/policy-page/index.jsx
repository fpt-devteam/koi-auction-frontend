        ...
        <div className="accordion-item">
            ...
            >
                <div className="accordion-summary">
                    ...
                    <div className={`accordion-summary-caret ${isOpen ? 'rotate-180' : ''}`}>
...
const PolicyPage = () => {
    ...
    return (
        <div className="policy-container">
            ...
            <div className="policy-footer">Thank you for choosing AuctionKoi.com. Your privacy is important to us, and we are committed to providing a secure and positive experience.</div>
        </div>
    );
};
