...
const staticTabsData = [
  {
    ...
    lotStatusIconLink: "/src/assets/icon/pending.png",
  },
  {
    lotStatusId: 2,
    lotStatusName: "Approved",
    lotStatusIconLink: "/src/assets/icon/accept.png",
  },
  {
    lotStatusId: 3,
    lotStatusName: "Rejected",
    lotStatusIconLink: "/src/assets/icon/rejected.png",
  },
  {
    lotStatusId: 4,
    lotStatusName: "In Auction",
    lotStatusIconLink: "/src/assets/icon/auction.png",
  },
  {
    lotStatusId: 5,
    lotStatusName: "Unsold",
    lotStatusIconLink: "/src/assets/icon/banned.png",
  },
  {
    lotStatusId: 6,
    lotStatusName: "To Pay",
    lotStatusIconLink: "/src/assets/icon/payment-method.png",
  },
  {
    lotStatusId: 7,
    lotStatusName: "To Ship",
    lotStatusIconLink: "/src/assets/icon/shipping.png",
  },
  {
    lotStatusId: 8,
    lotStatusName: "To Receive",
    lotStatusIconLink: "/src/assets/icon/receiver.png",
  },
  {
    lotStatusId: 9,
    lotStatusName: "Completed",
    lotStatusIconLink: "/src/assets/icon/completed.png",
  },
  {
    lotStatusId: 10,
    lotStatusName: "Canceled",
    lotStatusIconLink: "/src/assets/icon/cancel.png",
  },
  {
    lotStatusId: 11,
    lotStatusName: "Payment Overdue",
    lotStatusIconLink: "/src/assets/icon/cancel.png",
  },
];
    ...
    const fetchLotDataByStatus = async () => {
      try {
        ...
        if (!LotStatusId || LotStatusId <= 5) {
          ...
          const soldLotList = soldLotResponse?.data
            ?.reverse()
            .map((soldLot) => ({
              lotDto: {
              ...
              breederDetailDto: {
                ...
                farmAddress:
                  addressResponse.data.find(
                    (add) => add.UserId == soldLot.breederId
                  ).Address || "Unknown",
              },
            }));
